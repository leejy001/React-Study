...
const getPostSaga = craeteRequestSaga(GET_POST, api.getPost);
const getUsersSaga = craeteRequestSaga(GET_USERS, api.getUsers);

// function* getPostSaga(action) {
//   yield put(startLoading(GET_POST)); // 로딩 시작
//   // 피라미터로 action을 받아 오면 액션의 정보를 조회할 수 있다.
//   try {
